...
public void createGUI(){
  ...
  lblErodeSpeed = new GLabel(this, 10, 250, 140, 20);
  ...
  lblInitialSpeed = new GLabel(this, 10, 130, 140, 20);
  ...
  lblInitialWater = new GLabel(this, 10, 190, 140, 20);
  lblInitialWater.setText("Water volume");
  ...
  lblDropletLimit = new GLabel(this, 10, 70, 140, 20);
  ...
  btnReset = new GButton(this, 10, 30, 140, 30);
  btnReset.setText("Reset controls");
  ...
  pnlTools = new GPanel(this, 0, 470, 300, 150, "Tools");
  ...
  optMouseTerrain = new GOption(this, 20, 50, 70, 20);
  ...
  sliderBrushRadius = new GSlider(this, 10, 100, 140, 40, 10.0);
  ...
  sliderBrushHardness = new GSlider(this, 150, 100, 140, 40, 10.0);
  ...
  lblBrushRadius = new GLabel(this, 10, 80, 140, 20);
  lblBrushRadius.setText("Brush radius");
  lblBrushRadius.setOpaque(false);
  lblBrushHardness = new GLabel(this, 150, 80, 140, 20);
  lblBrushHardness.setText("Brush hardness");
  lblBrushHardness.setOpaque(false);
  lblMouseDescription = new GLabel(this, 110, 30, 190, 20);
  lblMouseDescription.setText("LClick: Add, RClick: Erase");
  lblMouseDescription.setOpaque(false);
  ...
  pnlTools.addControl(lblMouseDescription);
  pnlInfo = new GPanel(this, 0, 620, 300, 110, "Debug Info");
